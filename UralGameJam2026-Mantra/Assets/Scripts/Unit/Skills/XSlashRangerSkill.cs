...
[CreateAssetMenu(fileName = "XSlashRanger", menuName = "Unit/Skills/XSlashRanger")]
public class XSlashRangerSkill : Skill
{
    ...
    {
        var baseDamage = Mathf.Round((source.Damage.DealBaseDamage() * _attackModifier.Multiplyer) / _repeats);
